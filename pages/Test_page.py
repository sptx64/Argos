...
if bind :
    ...
    fig.add_trace(go.Scatter(x=data["Date"], y=data["bind"], mode='lines', marker_color='orange', showlegend=True), col=None if subplot==0 else 1, row=None if subplot==0 else 1)
