...
if bind :
    ...
    fig.add_trace(go.Scatter(x=data_bear_bind["Date"], y=data_bear_bind["Low"], mode='markers', marker_color='red', marker_symbol="triangle-down", showlegend=False), col=None if subplot==0 else 1, row=None if subplot==0 else 1)
